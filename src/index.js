...
const mediaQueries = {
  ...
  bluxomeMediaSm: `(min-width: ${breakpoints.bluxomeBreakpointSm})`,
  ...
  bluxomeMediaLtSm: `(max-width: ${breakpoints.bluxomeBreakpointLtSm})`,
